...
export const metadata: Metadata = { title: "Free Friends and Communication Verbs Lesson Pack for Beginner ESL", alternates: { canonical: `/free-resources/${slug}` } };
export default function Page() { return <BeginnerPackPage pack={{ slug, title: "Friends and Communication Verbs", topic: "Friends and Communication", words: cards.map((card) => card.word), cards, cardType: "verb", worksheet: "Classendo Friends and Communication Tic-Tac-Toe", activity: "Meet-and-Mingle", activityCopy: "", lessonCopy: "" }} />; }
