...
export const metadata: Metadata = {
  title: "ESL Flashcard Topics and Classroom Activities",
  description: "Browse visual vocabulary topics for ESL and English teachers, with flashcard, game, worksheet, and classroom activity ideas.",
  ...
  return (
    <main className="min-h-screen bg-[#f7f6f2] text-[#2f3a2f]">
      ...
      <section className="mx-auto max-w-6xl px-6 py-14 md:py-20">
        ...
        <h1 className="mt-3 max-w-4xl text-4xl font-semibold tracking-tight md:text-5xl">ESL vocabulary flashcards and activities by topic</h1>
        <p className="mt-5 max-w-3xl text-lg leading-8 text-[#5c665c]">Choose a classroom topic for ready-to-use vocabulary, a practical activity idea, and a simple route into Classendo&apos;s flashcards, worksheets, games, and printables.</p>
