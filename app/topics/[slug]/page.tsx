...
export async function generateMetadata({ params }: TopicPageProps): Promise<Metadata> {
  ...
  return { title: topic.title, description: topic.description, alternates: { canonical: path }, openGraph: { title: topic.title, description: topic.description, url: path, type: "website", siteName: "Classendo" } };
}
