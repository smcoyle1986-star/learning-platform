      ...
      <main className="min-h-screen bg-[#f7f6f2] px-4 py-8 text-[#2f3a2f] sm:px-6 sm:py-10">
        <section className="mx-auto max-w-5xl">
          ...
          <div className="mt-7 grid gap-5 md:grid-cols-3">
            <article className="rounded-[1.75rem] border border-[#dfe5d8] bg-white p-6"><div className="text-sm font-semibold uppercase tracking-[0.18em] text-[#6d8160]">Free</div><h2 className="mt-3 text-2xl font-bold">Start with Classendo</h2><p className="mt-4 text-sm leading-6 text-[#667066]">Play every game free with ready-made topics. With a free account, use your own vocabulary in the weekly featured game and access the featured worksheet.</p></article>
            <article className="rounded-[1.75rem] border border-[#dfe5d8] bg-white p-6"><div className="text-sm font-semibold uppercase tracking-[0.18em] text-[#6d8160]">Monthly</div><h2 className="mt-3 text-2xl font-bold">Premium Monthly</h2><div className="mt-4 text-4xl font-black">{monthlyPrice ?? "Monthly"}<span className="text-sm font-medium text-[#6b756b]"> / month</span></div><p className="mt-4 text-sm leading-6 text-[#667066]">Your own vocabulary in every game, plus unlimited worksheets, printables and saved My Lessons.</p><Link href="/signup?next=%2Fupgrade" className="btn btn-primary mt-6 w-full px-4 py-3">Start free trial</Link></article>
