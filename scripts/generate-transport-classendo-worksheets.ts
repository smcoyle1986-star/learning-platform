...
const dir = path.join(root, "tmp/pdfs/transport-classendo");
const entries = [["car","car"],["bus","bus"],["train","train"],["airplane","airplane"],["bike","bike"],["boat","boat"],["taxi","taxi"],["truck","truck"],["scooter","scooter"],["helicopter","helicopter"],["van","van"],["subway","subway"]] as const;
const cards: LessonCard[] = entries.map(([word,key], position) => ({ id:`transport-${position + 1}`, word, position, type:"noun", image:`https://tsccyjrniiamnwgrtvpw.supabase.co/storage/v1/object/public/vocab-images/nouns/${key}/${key}_1.png` }));
...
const tic: WorksheetDraft = { ...common,type:"tic-tac-toe",title:"Transport Tic-Tac-Toe",instructions:"Say the pictured transport correctly before writing X or O.",ticTacToeImageMode:"both",ticTacToeBoardCount:4,shuffleSeed:20260825 };
const bull: WorksheetDraft = { ...common,type:"bullseye",title:"Transport Bullseye",instructions:"Drop a token, say I go by ___, then take the printed score.",ticTacToeImageMode:"both",ticTacToeBoardCount:1,shuffleSeed:20260826 };
