...
const cards: LessonCard[] = words.map((word, position) => ({ id: `wild-${position + 1}`, word, position, type: "noun", image: `https://tsccyjrniiamnwgrtvpw.supabase.co/storage/v1/object/public/vocab-images/nouns/${word}/${word}_1.png` }));
const dir = path.join(process.cwd(), "tmp/pdfs/wild-animals-classendo");
...
const tic: WorksheetDraft = { ...common, type: "tic-tac-toe", title: "Wild Animals Tic-Tac-Toe", instructions: "Say the pictured wild animal correctly before writing X or O.", ticTacToeImageMode: "both", ticTacToeBoardCount: 4, shuffleSeed: 20260831 };
const bull: WorksheetDraft = { ...common, type: "bullseye", title: "Wild Animals Bullseye", instructions: "Drop a token, say It is a/an ___, then take the printed score.", ticTacToeImageMode: "both", ticTacToeBoardCount: 1, shuffleSeed: 20260901 };
