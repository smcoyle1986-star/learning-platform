...
const dir = path.join(root, "tmp/pdfs/weather-classendo");
const entries = [["sunny","sunny"],["stormy","stormy"],["windy","windy"],["blizzard","blizzard"],["cloudy","cloudy"],["hot","hot"],["warm","warm"],["foggy","foggy"],["lightning","lightning"],["rainbow","rainbow"]] as const;
const cards: LessonCard[] = entries.map(([word,key], position) => ({ id:`weather-${position + 1}`, word, position, type:"noun", image:`https://tsccyjrniiamnwgrtvpw.supabase.co/storage/v1/object/public/vocab-images/nouns/${key}/${key}_1.png` }));
...
const tic: WorksheetDraft = { ...common,type:"tic-tac-toe",title:"Weather Tic-Tac-Toe",instructions:"Say the pictured town place correctly before writing X or O.",ticTacToeImageMode:"both",ticTacToeBoardCount:4,shuffleSeed:20260821 };
const bull: WorksheetDraft = { ...common,type:"bullseye",title:"Weather Bullseye",instructions:"Drop a token, say the target sentence, then take the printed score.",ticTacToeImageMode:"both",ticTacToeBoardCount:1,shuffleSeed:20260822 };
