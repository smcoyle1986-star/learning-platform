...
const words = ["bed", "sofa", "chair", "lamp", "oven", "sink", "shower", "mirror", "wardrobe", "clock", "door", "window"];
const cards: LessonCard[] = words.map((word, position) => { const key = word; return { id: `things at home-${position + 1}`, word, position, type: "noun", image: `https://tsccyjrniiamnwgrtvpw.supabase.co/storage/v1/object/public/vocab-images/nouns/${key}/${key}_1.png` }; });
const dir = path.join(process.cwd(), "tmp/pdfs/things-at-home-classendo");
...
const tic: WorksheetDraft = { ...common, type: "tic-tac-toe", title: "Things at Home Tic-Tac-Toe", instructions: "Say the pictured things at home correctly before writing X or O.", ticTacToeImageMode: "both", ticTacToeBoardCount: 4, shuffleSeed: 20260912 };
const bull: WorksheetDraft = { ...common, type: "bullseye", title: "Things at Home Bullseye", instructions: "Drop a token, say It is in the ___, then take the printed score.", ticTacToeImageMode: "both", ticTacToeBoardCount: 1, shuffleSeed: 20260913 };
