...
const cards: LessonCard[] = words.map((word, position) => ({ id: `months-${position + 1}`, word, position, type: "noun", image: `https://tsccyjrniiamnwgrtvpw.supabase.co/storage/v1/object/public/vocab-images/nouns/${word}/${word}_1.png` }));
const dir = path.join(process.cwd(), "tmp/pdfs/months-classendo");
...
const tic: WorksheetDraft = { ...common, type: "tic-tac-toe", title: "Months of the Year Tic-Tac-Toe", instructions: "Say the pictured month correctly before writing X or O.", ticTacToeImageMode: "both", ticTacToeBoardCount: 4, shuffleSeed: 20260916 };
const bull: WorksheetDraft = { ...common, type: "bullseye", title: "Months of the Year Bullseye", instructions: "Drop a token, say It is ___, then take the printed score.", ticTacToeImageMode: "both", ticTacToeBoardCount: 1, shuffleSeed: 20260917 };
