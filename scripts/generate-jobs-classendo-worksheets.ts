...
const dir = path.join(root, "tmp/pdfs/jobs-classendo");
const entries = [["teacher","teacher"],["doctor","doctor"],["nurse","nurse"],["firefighter","firefighter"],["police officer","police_officer"],["chef","chef"],["farmer","farmer"],["mechanic","mechanic"],["artist","artist"],["vet","vet"],["builder","builder"],["dentist","dentist"]] as const;
const cards: LessonCard[] = entries.map(([word,key], position) => ({ id:`jobs-${position + 1}`, word, position, type:"noun", image:`https://tsccyjrniiamnwgrtvpw.supabase.co/storage/v1/object/public/vocab-images/nouns/${key}/${key}_1.png` }));
...
const tic: WorksheetDraft = { ...common,type:"tic-tac-toe",title:"Jobs Tic-Tac-Toe",instructions:"Say the pictured job correctly before writing X or O.",ticTacToeImageMode:"both",ticTacToeBoardCount:4,shuffleSeed:20260825 };
const bull: WorksheetDraft = { ...common,type:"bullseye",title:"Jobs Bullseye",instructions:"Drop a token, say I am a ___, then take the printed score.",ticTacToeImageMode:"both",ticTacToeBoardCount:1,shuffleSeed:20260826 };
