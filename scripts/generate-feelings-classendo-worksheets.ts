...
const dir = path.join(root, "tmp/pdfs/feelings-classendo");
const entries = [["happy","happy"],["sad","sad"],["angry","angry"],["scared","scared"],["tired","tired"],["hungry","hungry"],["thirsty","thirsty"],["excited","excited"],["bored","bored"],["worried","worried"],["surprised","surprised"],["confused","confused"]] as const;
const cards: LessonCard[] = entries.map(([word,key], position) => ({ id:`feelings-${position + 1}`, word, position, type:"noun", image:`https://tsccyjrniiamnwgrtvpw.supabase.co/storage/v1/object/public/vocab-images/adjectives/${key}/${key}_1.png` }));
...
const tic: WorksheetDraft = { ...common,type:"tic-tac-toe",title:"Feelings Tic-Tac-Toe",instructions:"Say the pictured feeling correctly before writing X or O.",ticTacToeImageMode:"both",ticTacToeBoardCount:4,shuffleSeed:20260825 };
const bull: WorksheetDraft = { ...common,type:"bullseye",title:"Feelings Bullseye",instructions:"Drop a token, say I feel ___, then take the printed score.",ticTacToeImageMode:"both",ticTacToeBoardCount:1,shuffleSeed:20260826 };
