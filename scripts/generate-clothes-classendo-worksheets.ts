...
const dir = path.join(root, "tmp/pdfs/clothes-classendo");
const entries = [["t-shirt","t_shirt"],["shirt","shirt"],["dress","dress"],["skirt","skirt"],["jeans","jeans"],["shorts","shorts"],["jacket","jacket"],["coat","coat"],["hat","hat"],["socks","socks"],["shoes","shoes"],["boots","boots"]] as const;
const cards: LessonCard[] = entries.map(([word,key], position) => ({ id:`clothes-${position + 1}`, word, position, type:"noun", image:`https://tsccyjrniiamnwgrtvpw.supabase.co/storage/v1/object/public/vocab-images/nouns/${key}/${key}_1.png` }));
...
const tic: WorksheetDraft = { ...common,type:"tic-tac-toe",title:"Clothes Tic-Tac-Toe",instructions:"Say the pictured clothing item correctly before writing X or O.",ticTacToeImageMode:"both",ticTacToeBoardCount:4,shuffleSeed:20260825 };
const bull: WorksheetDraft = { ...common,type:"bullseye",title:"Clothes Bullseye",instructions:"Drop a token, say I am wearing ___, then take the printed score.",ticTacToeImageMode:"both",ticTacToeBoardCount:1,shuffleSeed:20260826 };
