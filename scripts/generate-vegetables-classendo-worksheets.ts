...
const words = ["carrot", "potato", "tomato", "onion", "broccoli", "cucumber", "lettuce", "corn", "pepper", "mushroom", "cabbage", "pumpkin"];
const cards: LessonCard[] = words.map((word, position) => { const key = word; return { id: `vegetables-${position + 1}`, word, position, type: "noun", image: `https://tsccyjrniiamnwgrtvpw.supabase.co/storage/v1/object/public/vocab-images/nouns/${key}/${key}_1.png` }; });
const dir = path.join(process.cwd(), "tmp/pdfs/vegetables-classendo");
...
const tic: WorksheetDraft = { ...common, type: "tic-tac-toe", title: "Vegetables Tic-Tac-Toe", instructions: "Say the pictured vegetables correctly before writing X or O.", ticTacToeImageMode: "both", ticTacToeBoardCount: 4, shuffleSeed: 20260910 };
const bull: WorksheetDraft = { ...common, type: "bullseye", title: "Vegetables Bullseye", instructions: "Drop a token, say I like ___, then take the printed score.", ticTacToeImageMode: "both", ticTacToeBoardCount: 1, shuffleSeed: 20260911 };
