...
const words = ["pencil", "pen", "eraser", "ruler", "notebook", "paper", "scissors", "glue", "desk", "chair", "marker", "pencil case"];
const cards: LessonCard[] = words.map((word, position) => { const key = word === "pencil case" ? "pencil_case" : word; return { id: `classroom-${position + 1}`, word, position, type: "noun", image: `https://tsccyjrniiamnwgrtvpw.supabase.co/storage/v1/object/public/vocab-images/nouns/${key}/${key}_1.png` }; });
const dir = path.join(process.cwd(), "tmp/pdfs/classroom-classendo");
...
const tic: WorksheetDraft = { ...common, type: "tic-tac-toe", title: "Classroom Tic-Tac-Toe", instructions: "Say the pictured classroom item correctly before writing X or O.", ticTacToeImageMode: "both", ticTacToeBoardCount: 4, shuffleSeed: 20260906 };
const bull: WorksheetDraft = { ...common, type: "bullseye", title: "Classroom Bullseye", instructions: "Drop a token, say I need a/an ___, then take the printed score.", ticTacToeImageMode: "both", ticTacToeBoardCount: 1, shuffleSeed: 20260907 };
