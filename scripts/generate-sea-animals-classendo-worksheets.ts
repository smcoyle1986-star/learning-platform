...
const words = ["fish", "shark", "whale", "dolphin", "octopus", "crab", "turtle", "seahorse", "jellyfish", "starfish", "seal", "lobster"];
const cards: LessonCard[] = words.map((word, position) => ({ id: `sea-${position + 1}`, word, position, type: "noun", image: `https://tsccyjrniiamnwgrtvpw.supabase.co/storage/v1/object/public/vocab-images/nouns/${word}/${word}_1.png` }));
const dir = path.join(process.cwd(), "tmp/pdfs/sea-animals-classendo");
...
const tic: WorksheetDraft = { ...common, type: "tic-tac-toe", title: "Sea Animals Tic-Tac-Toe", instructions: "Say the pictured sea animal correctly before writing X or O.", ticTacToeImageMode: "both", ticTacToeBoardCount: 4, shuffleSeed: 20260902 };
const bull: WorksheetDraft = { ...common, type: "bullseye", title: "Sea Animals Bullseye", instructions: "Drop a token, say I can see a/an ___, then take the printed score.", ticTacToeImageMode: "both", ticTacToeBoardCount: 1, shuffleSeed: 20260903 };
