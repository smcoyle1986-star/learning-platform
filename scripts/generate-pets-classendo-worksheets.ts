...
const words = ["dog", "cat", "rabbit", "fish", "bird", "turtle", "hamster", "parrot", "puppy", "kitten", "mouse", "bunny"];
const cards: LessonCard[] = words.map((word, position) => ({ id: `pet-${position + 1}`, word, position, type: "noun", image: `https://tsccyjrniiamnwgrtvpw.supabase.co/storage/v1/object/public/vocab-images/nouns/${word}/${word}_1.png` }));
const dir = path.join(process.cwd(), "tmp/pdfs/pets-classendo");
...
const tic: WorksheetDraft = { ...common, type: "tic-tac-toe", title: "Pets Tic-Tac-Toe", instructions: "Say the pictured pet correctly before writing X or O.", ticTacToeImageMode: "both", ticTacToeBoardCount: 4, shuffleSeed: 20260904 };
const bull: WorksheetDraft = { ...common, type: "bullseye", title: "Pets Bullseye", instructions: "Drop a token, say I want a ___, then take the printed score.", ticTacToeImageMode: "both", ticTacToeBoardCount: 1, shuffleSeed: 20260905 };
