...
const words = ["apple", "banana", "orange", "strawberry", "watermelon", "pineapple", "pear", "peach", "lemon", "mango", "cherry", "kiwi"];
const cards: LessonCard[] = words.map((word, position) => { const key = word; return { id: `fruit-${position + 1}`, word, position, type: "noun", image: `https://tsccyjrniiamnwgrtvpw.supabase.co/storage/v1/object/public/vocab-images/nouns/${key}/${key}_1.png` }; });
const dir = path.join(process.cwd(), "tmp/pdfs/fruit-classendo");
...
const tic: WorksheetDraft = { ...common, type: "tic-tac-toe", title: "Fruit Tic-Tac-Toe", instructions: "Say the pictured fruit correctly before writing X or O.", ticTacToeImageMode: "both", ticTacToeBoardCount: 4, shuffleSeed: 20260908 };
const bull: WorksheetDraft = { ...common, type: "bullseye", title: "Fruit Bullseye", instructions: "Drop a token, say I like ___, then take the printed score.", ticTacToeImageMode: "both", ticTacToeBoardCount: 1, shuffleSeed: 20260909 };
