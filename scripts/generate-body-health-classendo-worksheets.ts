...
const dir = path.join(root, "tmp/pdfs/body-health-classendo");
const entries = [["head","head"],["eyes","eyes"],["ears","ears"],["mouth","mouth"],["hand","hand"],["feet","feet"],["headache","headache"],["toothache","toothache"],["medicine","medicine"]] as const;
const cards: LessonCard[] = entries.map(([word,key], position) => ({ id:`body-${position + 1}`, word, position, type:"noun", image:`https://tsccyjrniiamnwgrtvpw.supabase.co/storage/v1/object/public/vocab-images/nouns/${key}/${key}_1.png` }));
...
const tic: WorksheetDraft = { ...common,type:"tic-tac-toe",title:"Body & Health Tic-Tac-Toe",instructions:"Say the pictured body or health word correctly before writing X or O.",ticTacToeImageMode:"both",ticTacToeBoardCount:4,shuffleSeed:20260825 };
const bull: WorksheetDraft = { ...common,type:"bullseye",title:"Body & Health Bullseye",instructions:"Drop a token, say My ___ hurts./ I need ___, then take the printed score.",ticTacToeImageMode:"both",ticTacToeBoardCount:1,shuffleSeed:20260826 };
